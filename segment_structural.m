%Specify pwd and SPM_dir

function segment_structural(thepath, filename)
% we assume we are in the correct folder 
clear matlabbatch

%thepath='C:\Users\admin\Documents\Research\_HRV_DCM\Data_fmri\sub-032301\anat'
%filename='sub-032301_ses-01_acq-mp2rage_brain.nii'



%[structural_images,~]=spm_select('FPList',thepath,filename);

SPM_dir='/home/wjadvos/Documents/MATLAB/spm12'
%Segmentation
%matlabbatch{1}.spm.spatial.preproc.channel.vols = cellstr(structural_images);

matlabbatch{1}.spm.spatial.preproc.channel.vols={[thepath '/' filename]};
